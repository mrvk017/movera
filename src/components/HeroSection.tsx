  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      >
        ...
        <div className="next hidden md:flex absolute left-6 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/30 backdrop-blur-sm rounded-full items-center justify-center text-white hover:bg-white/40 transition-colors z-20">
          <ChevronLeft className="w-6 h-6" />
        </div>
        <div className="prev hidden md:flex absolute right-6 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/30 backdrop-blur-sm rounded-full items-center justify-center text-white hover:bg-white/40 transition-colors z-20">
