...
//       {/* Container relative to center */}
//       <div className="relative w-[500px] h-[500px]">
//         <div
//           className="absolute top-1/4 left-1/4 w-4 h-4 bg-white/60 rounded-full animate-pulse"
//           style={dotStyle(30, 30)}
//         />
//         <div
//           className="absolute top-1/3 left-2/3 w-6 h-6 bg-white/40 rounded-full animate-pulse delay-300"
//           style={dotStyle(50, 40)}
//         />
//         <div
//           className="absolute top-2/3 left-1/2 w-5 h-5 bg-white/50 rounded-full animate-pulse delay-700"
//           style={dotStyle(40, 60)}
//         />
//         <div
//           className="absolute bottom-1/4 left-1/3 w-8 h-8 bg-white/30 rounded-full animate-pulse delay-1000"
//           style={dotStyle(60, 30)}
//         />
//         <div
//           className="absolute bottom-1/3 right-1/4 w-3 h-3 bg-white/60 rounded-full animate-pulse delay-500"
//           style={dotStyle(35, 50)}
//         />
//         <div
//           className="absolute top-1/2 right-1/4 w-7 h-7 bg-white/35 rounded-full animate-pulse delay-200"
//           style={dotStyle(45, 25)}
//         />
//         <div
//           className="absolute top-1/4 right-1/3 w-20 h-20 bg-white/10 rounded-full animate-pulse delay-800"
//           style={dotStyle(70, 70)}
//         />
//         <div
//           className="absolute bottom-1/4 right-1/2 w-16 h-16 bg-white/15 rounded-full animate-pulse delay-600"
//           style={dotStyle(55, 65)}
//         />
//       </div>
//     </div>
